...
-- 단, 컬럼의 순서를 지켜서 VALUSE에 값을 기입해야 함

INSERT INTO EMPLOYEE2 VALUES
('900', '장채현', '901230-2345678', 'jang_ch@kh.or.kr',
...
-- 선택안된 컬럼은 값이 NULL이 들어감(DEFAULT 존재 시 DEFAULT 값으로 삽입)
...
UPDATE DEPARTMENT2
SET DEPT_ID  = 'D8', DEPT_TITLE = '전략기획2팀' -- WHERE절 직전 컬럼 작성 후 콤마 X
