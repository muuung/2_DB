...
SELECT ROUND(123.456, -2) FROM DUAL; -- 10의 자리에서 반올림 해서 100의 자리부터 표현
...
SELECT SUM(DECODE(SUBSTR(EMP_NO, 8, 1), '1', 1, 0)) FROM EMPLOYEE;