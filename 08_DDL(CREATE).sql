...
INSERT INTO MEMBER VALUES
('MEM03', 'ASDF9876', '박철수', '940416-1987654', DEFAULT);
...
INSERT INTO MEMBER VALUES
('MEM05', 'PASS05', '김길동', '930303-1333333',
...
INSERT INTO MEMBER2 VALUES
('MEM02', 'PASS02', '고길순', 01045678901);

-- NUMBER 타입 컬럼에 데이터 삽입 시
-- 제일 앞에 0이 있으면 이를 자동으로 제거
-- 전화번호, 주빈등록번호처럼 숫자로만 되어있는 데이터지만
...
-- 둘다 컬럼의 값을 지정된 형태로만 제한하지만
-- CHECK 작성 후 수정이 번거롭지만
...
ALTER TABLE EMPLOYEE ADD CONSTRAINT EMP_SAL_LELVEL
