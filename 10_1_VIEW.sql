/*	
	...
	VIEW 사용 목적
	복잡한 SELECT문을 쉽게 재사용하기 위해서
	테이블의 진짜 모습을 감출 수 있어 보안 상 유리
	
 	★VIEW 사용 시 주의사항★
	가상의 테이블(실제 테이블X) -> ALTER 구문 사용 불가
...
-- 정상적인 INSERT가 진행되지 않음!

-- VIEW의 본래 목적인 보여지는 것(조회)이라는 용도에 맞게 사용하는게 좋음
